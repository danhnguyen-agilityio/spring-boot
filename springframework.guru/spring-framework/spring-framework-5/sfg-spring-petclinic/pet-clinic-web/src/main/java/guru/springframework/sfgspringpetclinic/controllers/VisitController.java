...
public class VisitController {
     ...
     * - Sine we do not use the session scope, make sure that Pet object always has an id
    ...
    // Spring MVC calls method loadPetWithVisit(..) before initMewVisitForm is called
