...
public class ImageProxyTestDriver {
  public static void main(String[] args) throws Exception {
    ...
    new ImageProxy(new URL("https://st2.depositphotos.com/8291294/11285/i/950/depositphotos_112854140-stock-photo-unfocused-blurred-texture-patterns-abstract.jpg"))
        .paintIcon(null, null, 0, 0);
  }
}
